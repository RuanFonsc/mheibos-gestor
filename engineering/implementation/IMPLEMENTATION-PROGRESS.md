...
- Dívida de tipagem completa do legado (33 diagnósticos em 12 arquivos após correções incrementais) está rastreada em `engineering/implementation/TYPECHECK-DEBT.md`; o escopo dos ciclos novos permanece verde.
