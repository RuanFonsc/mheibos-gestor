...
- Dívida de tipagem completa do legado (20 diagnósticos em 6 arquivos após correções incrementais) está rastreada em `engineering/implementation/TYPECHECK-DEBT.md`; o escopo dos ciclos novos permanece verde.
