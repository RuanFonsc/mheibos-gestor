...
| IMP-009 | Arquivos e integrações oficiais | RFC-0014 | IMP-003, IMP-005 | COMPLETED_WITH_GAPS | alto | IMP-009A–L cobrem vínculo, criação oficial, monitoramento, conclusão, restauração crítica e transferência autorizada; falta criação provisória offline e permanecem lacunas normativas independentes de backup/agrupamento anual | 9 |
