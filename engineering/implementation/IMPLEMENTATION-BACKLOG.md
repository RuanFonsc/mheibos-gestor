...
| IMP-008 | Operação offline restrita e sincronização | RFC-0008 | IMP-002, IMP-003 | IN_PROGRESS | crítico | IMP-008A–D.1 concluíram operação local, Central, identidade, fallback e confirmação local durável; faltam transporte automático, smoke do pacote e retorno online | 8 |
