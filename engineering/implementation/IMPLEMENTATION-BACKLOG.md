...
| IMP-002 | Identidade, sessão e autorização central | RFC-0005, 0007 | IMP-001 | READY | alto | identidade estável, senha segura, sessão e ações sensíveis | 2 |
| IMP-003 | Eventos, evidências e auditoria aditiva | RFC-0006 | IMP-002 | PENDING | alto | evento versionado, correlação, ator, alvo, mudança e idempotência | 3 |
| IMP-004 | Pedido comercial com estados independentes | RFC-0005, 0013 | IMP-003 | PENDING | alto | comercial, financeiro e entrega separados com migração | 4 |
