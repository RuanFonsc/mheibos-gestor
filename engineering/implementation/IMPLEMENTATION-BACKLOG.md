...
Novas RFCs serão adicionadas ao backlog quando oficializadas. A RFC-0016 recebida como Draft orienta o IMP-013, mas seu catálogo concreto de ações autônomas permanece futuro. A fundação opcional de IMP-007A não torna IA obrigatória; ausência de IA não bloqueia IMP-001 a IMP-013. Na IMP-012, Dashboard, métricas, evidências, permissões e simulação determinística devem funcionar com a IA desligada; linguagem natural, análise cognitiva e reorganização inteligente conectam-se somente na fase de IA.
