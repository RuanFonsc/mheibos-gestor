...
| IMP-008 | Operação offline restrita e sincronização | RFC-0008 | IMP-002, IMP-003 | IN_PROGRESS | crítico | IMP-008A–C.2a concluíram fila, transporte, Estação e cache protegido da última identidade; faltam bootstrap/login local, envio automático e comutação Electron | 8 |
