...
| IMP-008 | Operação offline restrita e sincronização | RFC-0008 | IMP-002, IMP-003 | IN_PROGRESS | crítico | IMP-008A–D.2 concluíram operação local, Central, identidade, fallback, transporte autenticado e confirmação; faltam smoke do pacote e retorno seguro ao online | 8 |
