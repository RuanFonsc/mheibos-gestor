...
| IMP-008 | Operação offline restrita e sincronização | RFC-0008 | IMP-002, IMP-003 | IN_PROGRESS | crítico | IMP-008A–C.3 concluíram fila, transporte, Estação, identidade protegida e fallback inicial para SQLite; faltam smoke do pacote, retorno online, envio automático e confirmação local | 8 |
