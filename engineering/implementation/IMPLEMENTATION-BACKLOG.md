...
| IMP-009 | Arquivos e integrações oficiais | RFC-0014 | IMP-003, IMP-005 | IN_PROGRESS | alto | IMP-009A criou múltiplos vínculos oficiais, identidade imutável, backfill e auditoria; faltam criação física, monitoramento, anexos/referência, pesquisa, backup e revisão anual | 9 |
