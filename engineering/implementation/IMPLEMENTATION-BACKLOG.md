...
| IMP-008 | Operação offline restrita e sincronização | RFC-0008 | IMP-002, IMP-003 | IN_PROGRESS | crítico | IMP-008A–C.2b concluíram fila, transporte, Estação, cache protegido e bootstrap local conservador; faltam inicialização/login local, envio automático e comutação Electron | 8 |
