...
| IMP-008 | Operação offline restrita e sincronização | RFC-0008 | IMP-002, IMP-003 | IN_PROGRESS | crítico | IMP-008A–C.1 concluíram fila, transporte, provisionamento e segredo protegido no Windows; faltam última identidade offline, envio automático e comutação Electron | 8 |
