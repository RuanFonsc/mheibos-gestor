...
from .views import assistente, interface_inventario, confirmar_alteracao_status, enviar_mensagem, notificacoes_alertas, resumo_pedido, tarefa_status, whatsapp, whatsapp_etiqueta
