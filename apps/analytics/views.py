...
def analytics_home(request):
    ...
    return render(request, "analytics/analytics.html", {"operador_atual": operador, "evidencias": evidencias, "analises": analises, "simulacoes": simulacoes, "tipos_evidencia": TipoEvidencia.choices, "active": "analytics"})
