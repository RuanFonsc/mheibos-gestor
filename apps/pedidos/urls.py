...
urlpatterns = [
    ...
    path("<int:pk>/arquivos-oficiais/<uuid:arquivo_id>/transferir-provisorio/", views.pedido_transferir_arquivo_provisorio, name="pedido_transferir_arquivo_provisorio"),
    path("<int:pk>/arquivos-oficiais/<uuid:arquivo_id>/decidir-copia-local/", views.pedido_decidir_copia_local, name="pedido_decidir_copia_local"),
    ...
    path("<int:pk>/arte/transferir-responsabilidade/", views.pedido_transferir_responsabilidade_arte, name="pedido_transferir_responsabilidade_arte"),
